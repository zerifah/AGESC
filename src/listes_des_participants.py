...
import datetime  # pour indiquer la date
...
##########################
consigne_a_rendre_a = "Olivier Simon (SIM)"
consigne_jusquau = "lundi 15 novembre 2022"
...
class PDF(FPDF):
    def header(self):
        ...
        w = self.get_string_width(titre) + 6
        self.set_x((297 - w) / 2)
    ...
    def tableau_eleves(self, pdf, sujet):
        ...
        consigne2 = "- Feuille à rendre à " + consigne_a_rendre_a
        consigne2 += " jusqu'au " + consigne_jusquau
...
def creer_listes_de_controle(fichier_eleves, fichier_sujets):
    ...
    donnees = importer_donnees(fichier_eleves, fichier_sujets)
...
# creer_listes_de_controle('eleves_pour_listes_controle.csv', 'table_sujets.csv')
# creer_listes_de_controle('eleves_affectes.csv', 'sujets_test_16_mai.csv')
