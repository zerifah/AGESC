...
class App:
    ...
    police_bouton = ('courier', 15)
    police_titre_encadre = ("courier", 18, 'bold')
    police_corps_de_texte = ('courier', 15)
    ...
    def __init__(self):
        ...
        Module_Affectation(self.fenetre)
        Module_listes_participants(self.fenetre)
